...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		$sql = "INSERT INTO  billing (purchase_date,purchase_amount,payment_type,card_type,card_number,cvv_number,card_holder,note,status,customer_id,product_id) VALUES('$dt','100','Sell','$_POST[payment_type]','$_POST[card_number]','$_POST[cvv_number]','$_POST[card_holder]','$_POST[note]','Active','$_SESSION[customer_id]','$_GET[productid]')";
		$qsql = mysqli_query($con,$sql);
		if(mysqli_affected_rows($con) == 1)
		{
		...
		{
		    var_dump($qsql, mysqli_affected_rows($con));
			echo mysqli_error($con);
		}
...
<div class="w3_agileits_card_number_grid_left">
	<div class="controls">
		...
		<input name="card_number" id="card_number" maxlength="16" class="form-control" placeholder="Card number"  value="<?php echo $rsedit['card_number']; ?>">
