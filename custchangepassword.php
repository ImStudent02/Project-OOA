...
{
	$sql = "UPDATE customer SET password='".encrypt($_POST['npass'])."' WHERE email_id ='" . $_SESSION['loginemail'] . "' AND password='".encrypt($_POST['opass'])."'";
...
function validateform()
{
	...
	var alphanumericExp = /^[a-zA-Z0-9@_.,()'"[\]{}]{8,16}$/;//Variable to validate only alphanumerics
	...
	{
		document.getElementById("idopass").innerHTML ="old password should contain at least one digit, one lower case, one upper case, one special character and 8-16 characters....";	
		i=1;		
	}
	...
	{
		document.getElementById("idnpass").innerHTML ="New password should contain at least one digit, one lower case, one upper case, one special character and 8-16 characters....";		
		i=1;
	}
