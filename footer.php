                            ...
                            <div class="col-custom">
                                <div class="single-service">
                                    ...
                                    <div class="serivce-cont">
                                        <h3>No delivery</h3>
                                        <p>No shipping on any winning Bid, Just For Fun.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-custom">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="about-us-footer">
                                    <div class="footer-logo">
                                        <a href="index.php"><img src="img/logo/Web-logo.png" alt=" Ocean Of Auction"></a>
                                    </div>
                                </div>
                            </div>
...
?>
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="extra/T&C.html">Terms and conditions</a></li>
                                            </ul>
                                        </div>
                                         ...
                                         <div class="col-lg-3 col-md-6 col-sm-6">
                                            ...
                                            <ul>
                                                <li><a href="https://www.facebook.com/profile.php?id=100086343951777">Face book</a></li>
                                                <li><a href="https://www.instagram.com/invites/contact/?i=1pfskkq3r1e8o&utm_content=pjpzyt9">Instagram</a></li>
                                                <li><a href="https://twitter.com/oceanofauction?t=gEzJBeGrA5W59QHeEnQyNQ&s=08">Twitter</a></li>
                                            </ul>
                                        </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Copyright &copy; Ocean Of Auction. All Rights Reserved</div>
                            </div>	
                            <div class="col-lg-6 col-md-6">
