...
<head>
        ...
        <title>Ocean Of Auction | Ocean Of Your Desire.</title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-2 col-md-3 md-custom-12">
                                <!-- logo start -->
                                <div class="logo">
                                    <a href="index.php"><img src="img/logo/Web-logo.png" alt=" icon Ocean of Auction"></a> 
								</div>
                                <!-- logo end -->
                            </div>
...
<li><a href="viewbillingcustomer.php">View Trasaction</a></li>
	...
	?>
		...
		<li class="drodown-show"><a href="#"> Product <i class="fa fa-angle-down"></i></a>
			<ul class="open-dropdown setting">
				...
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
							<h1 class="title1"><span class="text">Ocean Of auction</span></h1>
