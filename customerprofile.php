...
{
	$sql = "UPDATE customer SET customer_fname='" . $_POST['customer_fname'] . "', customer_lname='" . $_POST['customer_lname'] . "',email_id='" . $_POST['email_id'] . "',address='" . $_POST['address'] . "',state='" . $_POST['state'] . "',city='" . $_POST['city'] . "',landmark='" . $_POST['landmark'] . "',pincode='" . $_POST['pincode'] . "',mobile_no='" . encrypt($_POST['mobile_no']) . "' WHERE  customer_id='". $_SESSION['customer_id'] ."'";
...
<div class="controls">
<label class="control-label">Customer First Name</label><span class="errormsg" id="errcustomer_name"></span>
<input class="billing-address-name form-control" type="text" name="customer_name" id="customer_name" placeholder="customer name" value="<?php echo $rsedit['customer_fname']; ?>">
</div>

<div class="controls">
<label class="control-label">Customer Last Name</label><span class="errormsg" id="errcustomer_name"></span>
<input class="billing-address-name form-control" type="text" name="customer_name" id="customer_name" placeholder="customer name" value="<?php echo $rsedit['customer_lname']; ?>">
</div>
...
<select  name="state" id="state" class="form-control">
	...
	<option value = "Other">Other of of india</option>
</select>
	</div>
</div>
<div class="w3_agileits_card_number_grid_left">
...
<div class="w3_agileits_card_number_grid_left">
	<div class="controls">
		...
		<input name="mobile_no" id="mobile_no" maxlenght="10" class="form-control" placeholder="Mobile number" value="
		<?php echo decrypt($rsedit['mobile_no']); ?>">
	</div>
</div>
